...
urlpatterns = [
    ...
    path('check_batch_info', views.check_batch_info, name="check_batch_info"),
    path('report_data_generation', views.report_data_generation, name="report_data_generation"),
    path('data_change_on_date', views.data_change_on_date, name="data_change_on_date"),
